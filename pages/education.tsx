...
export default function Home() {
  ...
  return (
    <Layout>
      ...
      <ol>
          <li>Профайлинг и его направления
            <ol>
          ...
          <li>Точки замирания и запоминания
            <ol>
          ...
          <li>Оценка правдивости утверждения
            <ol>
              <li>Анализ речи</li>
