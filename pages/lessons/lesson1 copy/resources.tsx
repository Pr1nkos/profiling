                    ...
                    <li>
                      ...
                      <div className="mb-6 ml-4 mt-2">
                        ...
                        <p className="mb-3 text-neutral-500 ">
                          Разрабатывает систему FACS (Facial Action Coding
                          System) которая позволяет анализировать выражение лица
                          и выявлять эмоциональные состояния человека.
                        </p>
                      </div>
                    </li>
                    ...
                    <li>
                      ...
                      <div className="ml-4 mt-2 pb-5">
                        ...
                        <p className="mb-3  text-black">
                          ...
                          автоматизировать процесс профайлинга и выявления лжи
                          по лицу.
                        </p>
                      </div>
                    </li>
                ...
                <li>
                  <div className="flex-start md:flex">
                    ...
                    <div className="mb-10 ml-6 block max-w-md rounded-lg bg-neutral-50 p-6 shadow-md shadow-black/5  ">
                      ...
                      <p className="mb-6  text-black ">
                        книга была написана Джоном Дугласом - является введением
                        в методику профайлинга, основанную на анализе поведения
                        преступников. В книге описываются различные методы
                        анализа поведения, такие как анализ сцены преступления,
                        интервью с свидетелями и жертвами, психологический
                        профиль преступника и т.д.
                      </p>
                ...
                <li>
                  <div className="flex-start md:flex">
                    ...
                    <div className="mb-10 ml-6 block max-w-md rounded-lg bg-neutral-50 p-6 shadow-md shadow-black/5  ">
                      ...
                      <p className="mb-6  text-black">
                        Рональда Акерс - книга является обзором современных
                        теорий криминального поведения. В книге описываются
                        психологические факторы, которые могут влиять на
                        криминальное поведение, такие как личностные
                        особенности, социальная среда, воспитание и т.д.
                      </p>
                ...
                <li>
                  <div className="flex-start md:flex">
                    ...
                    <div className="mb-10 ml-6 block max-w-md rounded-lg bg-neutral-50 p-6 shadow-md shadow-black/5  ">
                      ...
                      <p className="mb-6  text-black">
                        Шен Шен и др. - книга является обзором современных
                        методов распознавания выражений лица с помощью машинного
                        обучения. В книге описываются различные алгоритмы и
                        подходы к распознаванию эмоций по лицу.
                      </p>
                ...
                <li>
                  <div className="flex-start md:flex">
                    ...
                    <div className="mb-10 ml-6 block max-w-md rounded-lg bg-neutral-50 p-6 shadow-md shadow-black/5  ">
                      ...
                      <p className="mb-6  text-black">
                        Жан-Франсуа Мартин и др. - в книге указываются
                        современные системы распознавания лица и анализа
                        выражений для понимания человеческого поведения. В книге
                        описываются различные технологии, используемые для
                        распознавания лица и анализа выражений, такие как
                        компьютерное зрение, машинное обучение и т.д.
                      </p>
