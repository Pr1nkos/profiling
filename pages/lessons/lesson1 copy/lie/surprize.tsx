                ...
                <div className="space-y-6 sm:space-y-8 h-full w-full bg-gray-600 rounded-md bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-60 border border-gray-100 p-4">
                  <div className="space-y-2 md:space-y-4 ">
                    ...
                    <p className="text-black">
                      ...
                      изумления - это широко открытый рот, который может
                      выражать удивление и недоумение.
                    </p>
                    <p className="text-black">
                      2. Брови могут подняться и разойтись в стороны, что
                      создает впечатление удивления и непонимания.Брови могут
                      подняться и разойтись в стороны, что создает впечатление
                    ...
                    <p className="text-black">
                      4. Расширенные зрачки. Глаза могут расширяться, что
                      создает впечатление удивления и интереса.
                    </p>
                    <p className="text-black">
